...
Given those factual premises, below are my personal guiding principles for AI use. As noted above, these are truly intended to be specific to me, based on the ways that AI might manifest in my life and work, and my own tolerances for what I feel I can safely outsource. I am not suggesting that others must adopt these same guiding principles.
...
Using AI to translate language from one format to another is acceptable. 

Examples include:

* Coding (i.e., translating a request for what you want a computer to do into computer code)
* Translating any information from one language to another
* Translating content for a particular type of audience (e.g., “how would you explain this to a 9-year-old”)
...
* Identifying a bird you see in your yard
* Troubleshooting home projects
* Coming up with ideas for vacation
* Meal planning based on contents of your fridge

**Justification:** This use may become unavoidable, as it becomes what the internet is. The inaccuracy risk is going down all the time, and matters less (a bad choice for vacation isn’t the same as a made-up case in a brief). The main risk I see is developing the habit of turning to a robot instead of a human for things you might previously have asked a human, thereby decreasing overall human interactions. (And undercutting human creators, which is a risk for almost all AI uses.)

#### 5. Specific Editing/Proofreading Tasks

Using AI as a proofreader is acceptable in situations where the writing matters enough to justify AI use, and authenticity is less important.

Examples include:

* Checking important documents and emails for typos
* Helping identify and fix grammatical errors in important writing
* Doing a “tone check” in certain documents where tone really matters

**Justification:** This use falls within AI’s main skill set, and is relatively low risk. The biggest risk is leaning on AI too much (too much cognitive offloading).
...
#### 7. Producing New Content (something I might share with others) 

I will only use AI for this purpose **if the following criteria are all met**:

* Production of the type of content is outside my core skill set (or the skill set I am trying to learn), AND
* To produce the content myself would be more laborious than warranted by the project goal, AND
* I do not want any pride of authorship or sense of human creation, AND
* I am not signaling to others that the content is my human creation, AND
* There is not realistically a mechanism for me to get the content from a human creator.

Examples include:

* Custom illustrations for powerpoint slides or blog posts
...
**Note:** This rule does not prohibit sharing of AI-generated content as such -- for instance, sharing a link to a Westlaw Deep Research Memo or a link to a conversation with ChatGPT (provided I have fully read that content). This rule is about when I can use AI to produce new content that I then share in another format or context. 
...
Using AI to craft such messages mean they are inauthentic, and the risk of producing AI Slop is very high.

#### 3. Any writing that I am going to ask others to read but I haven’t read carefully in full

The risk that I am contributing to the universe of AI Slop is far too high for me to share AI-written content that I haven't fully read myself. That means that I will not send around an AI-produced memo on a topic or summary of something that I haven’t read in full. Another way to think of this rule is avoiding the “robots talking to the robots” situation – where, for instance, AI creates a survey, which is then filled out by AI, and AI then reads and summarizes the answers. If you use AI to create something that might be tempting to use AI to read or respond to, then you are at risk of violating this rule.
...
That means there must be robust verification processes for any legal work and any uses in research.

## Influential Sources:

* Ethan Mollick, “[Choosing to Stay Human](https://www.oneusefulthing.org/p/choosing-to-stay-human),” *One Useful Thing* (May 26, 2026).
* Jay Caspian Kang, “[Can A.I. Produce Writing That We Actually Want to Read?](https://www.newyorker.com/news/fault-lines/can-ai-produce-writing-that-we-actually-want-to-read),” *The New Yorker* (June 2, 2026).
* Shawn Smucker, “[Please Use AI](https://substack.com/@shawnsmucker/p-196249275),” *The Courage to Live It* (May 4, 2026).
* Rebecca Winthrop, “[What 370,000 College Essays Tell Us About A.I.’s Effects on Creativity](https://www.nytimes.com/2026/05/27/opinion/writing-creativity-ai.html),” *The New York Times* (May 27, 2026).
